...
import org.i3xx.lemonade.lang.util.lang.DefaultVariable;
import org.i3xx.lemonade.lang.util.lang.Language;
import org.i3xx.lemonade.lang.util.lang.LanguageException;
...
public class ClojureRt extends FunctionVars implements Language {
	...
	public Object execute(String name, String stmt, Map<String, Node> variables) throws LanguageException {
		...
		try {
			...
			throw new LanguageException(e, e.getLineNumber(), e.getColumnNumber(), stmt);
		}
